...
export type WorkerJob = {
  job_id: string;
  job_type: 'ifc_extraction' | 'pdf_extraction' | 'dxf_extraction' | 'image_metadata_extraction' | 'compliance_report' | 'assurance_plan_report' | 'completion_declaration_report' | 'dossier_report' | 'send_email';
