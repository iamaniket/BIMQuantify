...
Usage:
    uv run python -m bimquantify_api.seed
"""
...
from bimquantify_api.db import get_engine, get_session_maker
from bimquantify_api.models.organization import Organization
from bimquantify_api.models.user import User

SEED_ORG = "BIMQuantify"

SEED_USERS = [
    {
        "email": "superadmin@bimquantify.dev",
