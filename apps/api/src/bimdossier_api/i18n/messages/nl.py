...
nl_messages: Catalog = {
    ...
    "errors.USER_INACTIVE": "Dat account is opgeschort. Heractiveer het voordat je een wachtwoordherstel verstuurt.",
    "errors.USER_ALREADY_VERIFIED": "Dat account is al geactiveerd.",
    ...
    "errors.FREE_FINDING_NOT_FOUND": "Die bevinding kon niet worden gevonden.",
    "errors.FREE_PROJECT_NOT_FOUND": "Dat project kon niet worden gevonden.",
    "errors.FREE_DOCUMENT_NOT_FOUND": "Die container kon niet worden gevonden.",
    "errors.FREE_FILE_NOT_FOUND": "Dat bestand kon niet worden gevonden.",
    "errors.FREE_PROJECT_CAP_REACHED": "Je hebt de limiet voor gratis projecten bereikt. Verwijder een project of upgrade om er meer toe te voegen.",
    "errors.FREE_CREATE_FORBIDDEN": "Accounts die bij een werkruimte horen, kunnen geen gratis projecten aanmaken.",
    "errors.FREE_STORAGE_CAP_REACHED": "Je hebt de gratis opslaglimiet bereikt. Verwijder een model of upgrade voor meer ruimte.",
    ...
    "errors.FREE_WORKSPACE_UNAVAILABLE": "Je hebt geen gratis werkruimte om naar over te schakelen.",
    "errors.INVALID_FREE_STORAGE_KEY": "Die bestandsverwijzing is ongeldig.",
    "errors.FREE_ATTACHMENT_NOT_FOUND": "Die bijlage kon niet worden gevonden.",
    "errors.FREE_ATTACHMENT_NOT_PENDING": "Deze bijlage is al geüpload.",
    "errors.FREE_ATTACHMENT_NOT_READY": "Deze bijlage is nog niet gereed.",
    ...
    "errors.NO_IMPORTABLE_VERSION": "Er is geen modelversie klaar om te importeren.",
