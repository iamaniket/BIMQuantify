...
en_messages: Catalog = {
    ...
    "errors.USER_INACTIVE": "That account is suspended. Reactivate it before sending a password reset.",
    "errors.USER_ALREADY_VERIFIED": "That account is already activated.",
    ...
    "errors.FREE_FINDING_NOT_FOUND": "That finding could not be found.",
    "errors.FREE_PROJECT_NOT_FOUND": "That project could not be found.",
    "errors.FREE_DOCUMENT_NOT_FOUND": "That container could not be found.",
    "errors.FREE_FILE_NOT_FOUND": "That file could not be found.",
    "errors.FREE_PROJECT_CAP_REACHED": "You've reached the free project limit. Delete a project or upgrade to add more.",
    "errors.FREE_CREATE_FORBIDDEN": "Accounts that belong to a workspace can't create free projects.",
    "errors.FREE_STORAGE_CAP_REACHED": "You've reached the free storage limit. Delete a model or upgrade for more space.",
    ...
    "errors.FREE_WORKSPACE_UNAVAILABLE": "You don't have a free workspace to switch to.",
    "errors.INVALID_FREE_STORAGE_KEY": "That file reference is invalid.",
    "errors.FREE_ATTACHMENT_NOT_FOUND": "That attachment could not be found.",
    "errors.FREE_ATTACHMENT_NOT_PENDING": "This attachment has already been uploaded.",
    "errors.FREE_ATTACHMENT_NOT_READY": "This attachment isn't ready yet.",
    ...
    "errors.NO_IMPORTABLE_VERSION": "There's no model version ready to import.",
