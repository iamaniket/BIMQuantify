...
from bimdossier_api import jurisdictions
from bimdossier_api.i18n._types import Locale
...
def _coerce(value: str | None) -> Locale:
    # Inline to avoid a circular import with bimdossier_api.i18n.
    from bimdossier_api.i18n import PLATFORM_DEFAULT_LOCALE, SUPPORTED_LOCALES
