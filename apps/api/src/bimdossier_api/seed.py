...
Creates:
  * Platform org "BimDossier Platform" + super admin user.
...
Usage:
    uv run python -m bimdossier_api.seed             # idempotent — skips existing
    uv run python -m bimdossier_api.seed --reset     # TRUNCATE master, DROP tenant schemas, re-seed
"""
...
from bimdossier_api._rls_sql import grant_schema_to_app_role
from bimdossier_api.admin.provisioning import _run_sync_tenant_migrations
...
from bimdossier_api.tenancy import PLATFORM_ORG_NAME, schema_name_for
