...
nl_messages: Catalog = {
    ...
    "errors.SEAT_LIMIT_EXCEEDED": "Het maximumaantal gebruikers is bereikt. Verhoog de limiet of verwijder een lid voordat u uitnodigt.",
    ...
    # --- modellen / versies ---
    "errors.MODEL_NOT_FOUND": "Dat model kon niet worden gevonden.",
    ...
    # --- extractie / viewer ---
    "errors.EXTRACTION_NOT_COMPLETE": "Het extraheren van het model is nog niet voltooid.",
