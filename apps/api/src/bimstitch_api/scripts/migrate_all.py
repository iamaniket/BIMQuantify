...
Usage:
    uv run python -m bimstitch_api.scripts.migrate_all                # upgrade all
    uv run python -m bimstitch_api.scripts.migrate_all --check        # report drift, no writes
    uv run python -m bimstitch_api.scripts.migrate_all --concurrency 16
