...
/**
 * The org-scoped projects dashboard (paid users). Extracted from
 * `projects/page.tsx` so `useProjects()` (the org-scoped `GET /projects`, which
 * 409s for an org-less free user) never renders on the free path — the page
 * selects `<FreeProjectsView/>` vs this by `isFreeUser`.
 */
