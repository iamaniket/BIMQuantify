...
import { HowItWorksStorySection } from '@/components/sections/HowItWorksStorySection';
...
export default async function WelcomePage({ params }: Props): Promise<JSX.Element> {
  ...
  // then the workflow (watch it: the scroll-driven 3D story tour, then touch
  // it: the live board-to-dashboard demo), the capability catalog, an honest
  // trust band and an objection-resolving FAQ, before demoting the unbuilt
  // roadmap and closing on the CTA. The blog strip self-hides while the blog
  // is empty.
  return (
    <main>
      <HeroSection />
