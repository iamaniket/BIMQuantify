 ...
 * Dutch government. Returns a URL the <Image> loads directly; nothing is stored
 * on our side. Mirrors apps/portal's mapThumbnail so web + mobile cards share
 * the same location-image fallback.
 *
...
const DEFAULT_LON_HALF_SPAN = 0.0017; // ≈ 110 m E–W at 52° N
const DEFAULT_WIDTH = 360;
const DEFAULT_HEIGHT = 240; // 6:4, matches the card thumb
