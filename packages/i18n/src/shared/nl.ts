...
export const sharedNlMessages: SharedMessages = {
  brand: {
    ...
    strapline: 'Bouwkwaliteitsplatform',
    tagline: 'Het bouwkwaliteitsplatform voor Nederlandse aannemers.',
    productDescription:
      'Het bouwkwaliteitsplatform voor Nederlandse aannemers. Houd deadlines bij, beheer documenten, los bevindingen op en dien op tijd in.',
